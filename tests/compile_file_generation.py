...
class compile_file_generation(object):
    ...
    def __init__(
        ...
        self.run_dir = os.path.abspath(
            run_dir.strip()
        )  ## execution directoy i.e. /home/fpga/SM_FPGA/par  or /home/fpga/SM_FPGA/scratch/test/rtl_sim
        ...
        #######################
        #### this is the main object list for compile items parsed from comile.txt floe
        self.items = []
        #######################

        ## use as runing tab to make sure compile.txt recursion doesn't go into infinite loop on same compile.txt file references
    ...
    ## If another compile*.txt file is encounterd, call this function recursively.
...
if __name__ == "__main__":
    ...
    # first find the path excluding the workspace directory and the worspace directory
